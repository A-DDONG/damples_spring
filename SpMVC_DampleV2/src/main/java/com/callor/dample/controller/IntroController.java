...
public class IntroController {
	...
	public IntroController(BoardService boardService, 
			@Qualifier(QualifierConfig.SERVICE.FILE_V2) FileService fileService,
			FileDao fileDao) {
		super();
	...
	public String home(FileDto fileDto, BoardDto boardDto, Model model) {
		List<BoardDto> boardList = boardService.selectCategory("소개");
	...
	public String update(@PathVariable("b_seq") String bseq,
		...
		try {
			...
			return "redirect:/intro/{b_seq}/detail";
